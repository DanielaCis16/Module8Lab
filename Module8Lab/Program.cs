...
//When the program is executed, a new instance of the PojemonLinqLab class
...
class PokemonLinqLab {
    ...
    static void Main() {
        ...
        //SELECT * FORM pokemons WHERE level >= 16 ORDER BY Level

        // Execute the query to display the results
        Console.WriteLine("Pokemon Ready to Evolve: ");
        //Use a foreach loop to irerate through the list elements
